...
public class ConvidadoApiController {
	...
	@PutMapping("/{codigo}")
	@ResponseBody
	public ResponseEntity atualizarCliente(@PathVariable("codigo") Long condigo, @RequestBody Convidado convidado) {
		return cr.findById(condigo).map(convidadoExistente -> {
